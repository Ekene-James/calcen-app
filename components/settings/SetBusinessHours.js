...
import { addSettings, handleSnackBar } from '../../store/admin/AdminAction';
...
export default function SetBusinessHours({setinView}) {
 ...
 formData.append('answering_file',answering_file)
 ...
 adminCtx.dispatch(addSettings(formData,adminCtx.dispatch))
  }
  const listArr =[
    {
    ...
    <Grid container spacing={3}>
        ...
        <Grid item xs={12} >
          ...
          <CustomTxt engTxt={'Answering machine audio file'} japTxt={'留守番電話の音声ファイル'} type='h5'style={{margin:0,padding:0}}/>
            ...
            <div>
              <input type='file' id='uploads'  onChange={handleFileUpload}  />
